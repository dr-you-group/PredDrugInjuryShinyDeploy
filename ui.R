...
ui <- shinydashboard::dashboardPage(skin = 'black',
                                    ...
                                    shinydashboard::dashboardSidebar(
                                      shinydashboard::sidebarMenu(id ='menu',
                                                                  addInfo(shinydashboard::menuItem("Description", tabName = "Description", icon = shiny::icon("house")), "DescriptionInfo"),
                                                                  addInfo(shinydashboard::menuItem("Summary", tabName = "Summary", icon = shiny::icon("table")), "SummaryInfo"),
                                                                  addInfo(shinydashboard::menuItem("Performance", tabName = "Performance", icon = shiny::icon("chart-column")), "PerformanceInfo"),
                                                                  addInfo(shinydashboard::menuItem("Model", tabName = "Model", icon = shiny::icon("clipboard")), "ModelInfo"),
                                                                  addInfo(shinydashboard::menuItem("Settings", tabName = "Settings", icon = shiny::icon("cog", lib = "glyphicon")), "SettingsInfo"),
